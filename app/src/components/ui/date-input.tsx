...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex border rounded-md items-center text-sm px-3 py-2 h-10 ring-offset-background focus-within:outline-none focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
      <input
        type="text"
        ref={dayRef}
        max={31}
